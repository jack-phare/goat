...
func (g *GrepTool) Description() string {
	return "A powerful search tool built on ripgrep. Supports full regex syntax. Output modes: \"content\" shows matching lines, \"files_with_matches\" shows only file paths (default), \"count\" shows match counts."
}
